...
return (
   ...
   {section && section.map((item,index)=>{
        return(
            <p id={index} className={item.menu_category===selected?`p-2 text-red-500 underline underline-offset-8  decoration-red-700 font-bold`:`p-2 font-bold`} key={index} onClick={clickhandle(item.menu_category)}>{item.menu_category}</p>)
    ...
    {
      selected==='Salads and Soup' && salad && salad.map((item,index)=>{
            return(<>
            <div className="flex">
                <div>
                ...
                <GrSquare color={item.dish_Type===2?'green':'red'} className="m-2"/>
...
{item.dish_description}
                ...
                <img src={item.dish_image} alt="salad" className="rounded-md w-24 pr-2 mr-2"/>
...
<hr className="m-4 bg-slate-300"  />
        ...
        {
            selected==='From The Barnyard' && barn && barn.map((item,index)=>{
                return(<>
                    <div className="flex">
                        <div>
        ...
        <hr className="m-4 bg-slate-300"  />
            ...
            {
                selected==='From the Hen House' && hen && hen.map((item,index)=>{
                    return(<>
                        <div className="flex">
                            <div>
            ...
            {
                selected==='Fresh From The Sea' && sea && sea.map((item,index)=>{
                    return(<>
                        <div className="flex">
                            <div>
            ...
            {
                selected==='Fast Food' && fastfood && fastfood.map((item,index)=>{
                    return(<>
                        <div className="flex">
                            <div>
